...
class Benutzer {
    ...
    public constructor(nam: string, vorn: string, email: string, Rolle: string, password: string = "", id: number) {
        this.Nachname = nam;
        this.Vorname = vorn;
        this.Email = email;
        this.Id = id;
...
function ApplyFilter() {
    var nachnameFilter: string = (<HTMLInputElement>document.getElementById("nachnameFilter")).value.trim();
    var vornameFilter: string = (<HTMLInputElement>document.getElementById("vornameFilter")).value.trim();
    var rolleFilter: string = (<HTMLSelectElement>document.getElementById("rolleFilter")).selectedOptions[0].value;
    var orderByFilter: string = (<HTMLSelectElement>document.getElementById("orderByFilter")).selectedOptions[0].value;
    var orderType: string = (<HTMLSelectElement>document.getElementById("orderType")).selectedOptions[0].value;
...
function updateUser(benutzerId) {
    var myRow: HTMLTableRowElement = <HTMLTableRowElement>document.getElementById("row" + benutzerId);
...
function saveUserChanges(benutzerId) {
    ...
    let name_input: HTMLInputElement = <HTMLInputElement>document.getElementById("name" + benutzerId);
    ...
    let vorname_input: HTMLInputElement = <HTMLInputElement>document.getElementById("vorname" + benutzerId);
    ...
    let email_input: HTMLInputElement = <HTMLInputElement>document.getElementById("email" + benutzerId);
    ...
    let rolle_input: HTMLSelectElement = <HTMLSelectElement>document.getElementById("rolle" + benutzerId);
...
function fillUserTable() {
    ...
    var table: HTMLTableElement = <HTMLTableElement>document.getElementById("userstableView");
