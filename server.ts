...
class MessageToClient {
    ...
    constructor(_function: string, message: string, messageType: string) {
...
var currentMessageToClient: MessageToClient = null;
...
myWebServer.get("/users/add", (req: express.Request, res: express.Response) => {
...
myWebServer.get("/messages", (req: express.Request, res: express.Response) => {
...
myWebServer.get("/users", (req: express.Request, res: express.Response) => {
...
myWebServer.post("/users/delete", (req: express.Request, res: express.Response) => {
...
//event put
myWebServer.post("/users/update", (req: express.Request, res: express.Response) => {
...
myWebServer.use((req: express.Request, res: express.Response) => {
    res.status(404);
